...
if __name__ == "__main__":
    ...
    parser.add_argument('--pose_save', type=bool, default=False)
    ...
    for sub in subs:
        ...
        pose_out = join(args.output, 'pose', sub)
        ...
        if mode == 'openpose':
            ...
            config[mode]['ext'] = args.ext
            extract_2d(image_root, annot_root, pose_out, config[mode], mode=mode.replace('mp-', ''), pose_save=args.pose_save)
