...
class FLAME(nn.Module):
    ...
    def forward(self, shape_params, cameras=None, trans_params=None, rot_params=None, neck_pose_params=None, jaw_pose_params=None, eye_pose_params=None, expression_params=None, eyelid_params=None):
